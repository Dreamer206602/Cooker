...
public class CookDetailAdapter extends RecyclerView.Adapter<CookDetailAdapter.ItemViewHolder> {
    ...
    private static class CookDetailStruct{
        ...
        public static List<CookDetailStruct>create(List<CookRecipeMethod> cookDetailStructs){
            ...
            datas.add(new CookDetailStruct(Cook_Detail_Item_Type_Header));
                    ...
                    if(cookDetailStructs==null){
                        return datas;
                    }

            for(CookRecipeMethod item:cookDetailStructs){
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(Cook_Detail_Item_Type_CookMan == viewType){
            CookManItemViewHolder holder = new CookManItemViewHolder(
                    LayoutInflater.from(mContext).inflate(R.layout.item_cook_detail_cookman, parent, false)
            );
            ...
            HeaderItemViewHolder holder = new HeaderItemViewHolder(
                    LayoutInflater.from(mContext).inflate(R.layout.item_cook_detail_header, parent, false)
            ...
            StepItemViewHolder holder = new StepItemViewHolder(
                    LayoutInflater.from(mContext).inflate(R.layout.item_cook_detail_step, parent, false)
            );
